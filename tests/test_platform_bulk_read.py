...
from earthdaily.internal import BulkSearchService
from earthdaily.internal._bulk_search import BulkSearchCreateResponse, BulkSearchJob
...
class TestBulkSearchService(unittest.TestCase):
    ...
    @patch("earthdaily.internal._bulk_search.HttpDownloader")
    ...
    def test_send_request_custom_endpoint(self):
        ...
        self.assertEqual(args[0].method, "GET")
        self.assertEqual(args[0].url, "https://api.example.com/platform/v1/custom/endpoint")
