...
from earthdaily.internal._bulk_insert import (
    BulkInsertJob,
    BulkInsertService,
    ItemError,
    UploadConfig,
...
class TestBulkInsertService(unittest.TestCase):
    ...
    def test_create_bulk_insert_success(self):
        ...
        expected_url = "https://api.example.com/platform/v1/stac/bulk_insert/jobs"
        expected_body = {
    ...
    def test_fetch_job_status(self):
        ...
        # Verify the request was made correctly
        expected_url = "https://api.example.com/platform/v1/stac/bulk_insert/jobs/test_job_id"
        self.mock_api_requester.send_request.assert_called_once()
        actual_request = self.mock_api_requester.send_request.call_args[0][0]
    ...
    def test_start_job(self):
        ...
        expected_url = f"https://api.example.com/platform/v1/stac/bulk_insert/jobs/{job_id}/start"
        self.mock_api_requester.send_request.assert_called_once()
        actual_request = self.mock_api_requester.send_request.call_args[0][0]
        self.assertEqual(actual_request.method, "POST")
        self.assertEqual(actual_request.url, expected_url)
    ...
    @patch("earthdaily.internal._bulk_insert.HttpUploader")
